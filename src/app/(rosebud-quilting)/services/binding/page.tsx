...
import { Clock, Star, ArrowRight, CheckCircle, Scissors, Ruler, Palette, Zap } from "lucide-react";

export const metadata = generateMetadata({
  title: "Professional Quilt Binding Services",
  description: "Expert quilt binding and finishing services. Choose from machine or hand binding options to perfectly complete your quilting projects.",
});
...
const services = [
  {
    ...
    description: "Perfectly cut binding strips on the bias or straight grain for optimal results."
  },
  {
    icon: Ruler,
    title: "Professional Mitering",
    description: "Expert corner mitering techniques for crisp, clean corners every time."
  },
  {
    icon: Palette,
    title: "Color Consultation",
    description: "Help choosing the perfect binding fabric to complement your quilt design."
  },
  {
    icon: Zap,
    title: "Quick Service",
    description: "Fast turnaround times to get your finished quilt back in your hands quickly."
  }
];
...
const bindingStyles = [
  {
    ...
    description: "Classic straight-grain binding, perfect for most quilt projects",
...
const process = [
  {
    ...
    description: "Choose your binding style, fabric, and application method based on your quilt's needs."
  },
  {
    step: "2", 
    title: "Preparation",
    description: "We trim your quilt edges, prepare binding strips, and ensure everything is ready."
  },
  {
    step: "3",
    title: "Professional Application",
    description: "Expert application with precise mitered corners and consistent seam allowances."
  },
  {
    step: "4",
    title: "Quality Finishing",
    description: "Final inspection and any touch-ups to ensure your binding is perfectly finished."
  }
];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Complete your quilting project with professional binding services. Whether you 
              prefer machine or hand binding, we'll give your quilt the perfect finishing 
              touch it deserves.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center gap-4 mb-6">
                ...
                <span className="text-sm font-medium">1000+ quilts bound perfectly</span>
              </div>
              ...
              <p className="text-muted-foreground mb-6">
                Binding is the final step that transforms your quilt top into a finished 
                masterpiece. Our experienced team ensures crisp corners, even stitching, 
                and a professional finish that will last for generations.
              </p>
              ...
              <div className="absolute -bottom-6 -left-6 bg-white p-4 rounded-lg shadow-lg">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">Depending on binding type</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Professional techniques and attention to detail for the perfect finish
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {bindingOptions.map((option, index) => (
              <Card key={index} className={`relative ${option.popular ? 'ring-2 ring-purple-500' : ''} hover:shadow-lg transition-shadow`}>
                {option.popular && (
                ...
                <CardHeader className="text-center pb-8">
                  ...
                  <div className="text-sm text-muted-foreground">{option.unit}</div>
          ...
          <div className="text-center mt-12">
            <Card className="max-w-2xl mx-auto">
              <CardContent className="p-6">
                <h3 className="text-xl font-semibold mb-3">Need Help Calculating?</h3>
                <p className="text-muted-foreground mb-4">
                  To estimate your binding cost, measure the perimeter of your quilt 
                  (length + width) × 2 + 10 inches for corners and seams.
                </p>
                <p className="text-sm text-muted-foreground">
                  Example: A 60" × 80" quilt needs approximately 290 linear feet of binding
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="py-20 bg-purple-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Let us give your quilt the professional binding it deserves. 
            Contact us to discuss your binding options and schedule your service.
          </p>
