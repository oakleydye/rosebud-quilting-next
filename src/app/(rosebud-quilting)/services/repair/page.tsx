...
export const metadata = generateMetadata({
  ...
  description:
    "Expert quilt repair and restoration services to preserve your cherished quilts. From minor fixes to complete restoration, we bring new life to damaged quilts.",
});
...
const specialties = [
  {
    ...
    description:
      "Preserve precious family quilts for future generations with expert restoration.",
  },
  {
    icon: Shield,
    title: "Damage Prevention",
    description:
      "Preventive maintenance and reinforcement to extend your quilt's lifespan.",
  },
  {
    icon: Sparkles,
    title: "Vintage Restoration",
    description:
      "Specialized techniques for antique and vintage quilts requiring delicate care.",
  },
  {
    icon: Camera,
    title: "Documentation",
    description:
      "Before and after photos plus detailed condition reports for insurance.",
  },
];
...
const repairTypes = [
  {
    type: "Binding Repair",
    description:
      "Replace worn or damaged binding with matching or complementary fabrics",
    turnaround: "3-5 days",
  },
  {
    type: "Fabric Patching",
    description:
      "Carefully patch holes and tears with period-appropriate or matching fabrics",
  ...
  },
  {
    ...
    description:
      "Full assessment and restoration of extensively damaged quilts",
...
const process = [
  {
    ...
    description:
      "Thorough evaluation of damage with detailed photos and condition report.",
  },
  {
    step: "2",
    title: "Repair Plan & Quote",
    description:
      "Comprehensive repair strategy with transparent pricing and timeline.",
  },
  {
    step: "3",
    title: "Expert Restoration",
    description:
      "Skilled artisans perform repairs using appropriate techniques and materials.",
  },
  {
    step: "4",
    title: "Quality Check & Care Guide",
    description:
      "Final inspection and personalized care instructions for ongoing preservation.",
  },
];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-10">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Breathe new life into damaged or worn quilts with our expert
              repair and restoration services. From family heirlooms to everyday
              quilts, we preserve the memories and extend the life of your
              cherished pieces.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-muted-foreground mb-6">
                Every quilt tells a story, and damage shouldn't end that
                narrative. Our skilled artisans use time-tested techniques and
                modern conservation methods to restore quilts while preserving
                their original character and historical integrity.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {repairServices.map((service, index) => (
              <Card
                key={index}
                className={`relative ${service.popular ? "ring-2 ring-emerald-500" : ""} hover:shadow-lg transition-shadow`}
              >
                {service.popular && (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button
              size="lg"
              variant="outline"
              className="border-white text-primary hover:bg-white hover:text-emerald-600"
              asChild
            >
