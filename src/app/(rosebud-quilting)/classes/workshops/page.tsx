...
export const metadata = generateMetadata({
  ...
  description: "Join our waitlist for intensive quilting workshops. Special one-day and weekend sessions focusing on specific techniques and skills.",
});
        ...
        <div className="container mx-auto px-4 mt-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed max-w-3xl mx-auto">
              Intensive hands-on workshops designed to teach specific techniques in focused sessions. 
              Perfect for busy quilters who want to learn new skills in concentrated time periods.
              Join our waitlist to be notified when workshops become available!
            </p>
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl font-bold text-center mb-4">Planned Workshop Topics</h2>
            <p className="text-gray-600 text-center mb-12">
              Specialized workshops we're developing for different skill levels and interests
            </p>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
              {[
                ...
                },
                {
                  ...
                  duration: "1 Day",
                  price: "$90",
                  description: "Master foundation paper piecing with complex star patterns."
                },
                {
                  ...
                  duration: "2 Days",
                  price: "$165",
                  description: "Develop confidence and artistry in free-motion quilting techniques."
                },
                {
                  ...
                  duration: "Half Day",
                  price: "$45",
                  description: "See professional longarm quilting in action and try it yourself."
                },
                {
                  ...
                  duration: "Half Day",
                  price: "$55",
                  description: "Master multiple binding techniques for professional finishes."
                }
              ].map((workshop, index) => (
                <Card key={index} className="hover:shadow-lg transition-shadow">
                  <CardHeader>
                    <div className="flex justify-between items-start mb-2">
                      ...
                      <span className="text-lg font-bold text-orange-600">{workshop.price}</span>
                    </div>
                  ...
                  <CardContent className="pt-6">
                    <div className="space-y-4">
                      <div className="flex items-center">
                        ...
                        <span className="font-medium">15+ people interested</span>
                      </div>
                      <p className="text-sm text-gray-700">
                        Perfect for quilters who want focused, intensive learning experiences on specific techniques.
                      </p>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent>
                    <ul className="space-y-2">
                      <li className="flex items-start">
                        ...
                        <span className="text-sm">Intensive focus on specific techniques</span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle className="w-4 h-4 mr-3 mt-0.5 text-orange-600 flex-shrink-0" />
                        <span className="text-sm">Small group personalized instruction</span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle className="w-4 h-4 mr-3 mt-0.5 text-orange-600 flex-shrink-0" />
                        <span className="text-sm">Flexible weekend scheduling</span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle className="w-4 h-4 mr-3 mt-0.5 text-orange-600 flex-shrink-0" />
                        <span className="text-sm">All materials and supplies included</span>
                      </li>
                    </ul>
                  </CardContent>
                </Card>
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-orange-100 text-lg mb-8 leading-relaxed">
              Join our waitlist and be the first to access our specialized workshop series!
            </p>
