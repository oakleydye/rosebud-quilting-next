...
export const metadata = generateMetadata({
  ...
  description:
    "Join our waitlist for advanced quilting classes. Master complex techniques, artistic expression, and professional-level skills.",
});
        ...
        <div className="container mx-auto px-4 mt-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed max-w-3xl mx-auto">
              Master the art of quilting with our planned 10-week advanced
              program. Perfect for experienced quilters ready to explore complex
              techniques, artistic expression, and professional-level skills.
              Join our waitlist to be notified when classes become available!
            </p>
                  ...
                  <CardContent className="pt-6">
                    <div className="space-y-4">
                      ...
                      <p className="text-sm text-gray-700">
                        For experienced quilters ready to master professional
                    ...
                    <ul className="space-y-2">
                      <li className="flex items-start">
                        ...
                        <span className="text-sm">
                          Paper piecing mastery and complex patterns
                        </span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle className="w-4 h-4 mr-3 mt-0.5 text-emerald-600 flex-shrink-0" />
                        <span className="text-sm">
                          Advanced appliqué techniques
                        </span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle className="w-4 h-4 mr-3 mt-0.5 text-emerald-600 flex-shrink-0" />
                        <span className="text-sm">
                          Free-motion quilting artistry
                        </span>
                      </li>
                      <li className="flex items-start">
                        <CheckCircle className="w-4 h-4 mr-3 mt-0.5 text-emerald-600 flex-shrink-0" />
      ...
      <section className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-gray-600 text-center mb-12">
              This class is designed for experienced quilters ready for a
              challenge
            </p>
              ...
              <CardContent className="pt-6">
                <ul className="space-y-3">
                  <li className="flex items-start">
                    <CheckCircle className="w-4 h-4 mr-3 mt-0.5 text-emerald-600 flex-shrink-0" />
                    <span className="text-sm">
                      Completed 10+ quilts with varied techniques
                    </span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="w-4 h-4 mr-3 mt-0.5 text-emerald-600 flex-shrink-0" />
                    <span className="text-sm">
                      Proficient in intermediate piecing and appliqué
                    </span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="w-4 h-4 mr-3 mt-0.5 text-emerald-600 flex-shrink-0" />
                  ...
                  <li className="flex items-start">
                    <CheckCircle className="w-4 h-4 mr-3 mt-0.5 text-emerald-600 flex-shrink-0" />
                    <span className="text-sm">
                      Strong foundation in color theory and design
                    </span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle className="w-4 h-4 mr-3 mt-0.5 text-emerald-600 flex-shrink-0" />
                    <span className="text-sm">
                      Commitment to creative exploration and artistic growth
                    </span>
                  </li>
                </ul>
              </CardContent>
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-emerald-100 text-lg mb-8 leading-relaxed">
              Join our waitlist and become part of an elite group of advanced
              quilting artists!
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href="/contact">
                <Button
                  size="lg"
                  variant="outline"
                  className="border-white text-emerald-600 hover:bg-white hover:text-emerald-600"
                >
                  Ask Questions
                </Button>
              </Link>
